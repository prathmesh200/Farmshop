...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        view = getLayoutInflater().inflate(R.layout.dialog_box1,null);
        farmerbtn = view.findViewById(R.id.farmer_button);
        dealerbtn = view.findViewById(R.id.dealer_button);
...
//    checkTypeIsPresent();
    ...
    private void insertData(String types) {
        DatabaseReference insertdata = FirebaseDatabase.getInstance().getReference().child("Details").child(user_id);
        insertdata.child("types").setValue(types);
    }
